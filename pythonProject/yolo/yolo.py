...
img = cv2.imread("D:\pythonProject\yolo\people.jpg")
#print(img)
...
model = cv2.dnn.readNetFromDarknet("D:\pythonProject\yolo\modelleme\yolov3.cfg",
                                   "D:\pythonProject\yolo\modelleme\yolov3.weights")
layers = model.getLayerNames()

output_layer = []
for layer in model.getUnconnectedOutLayers():
    output_layer.append(layers[layer - 1])
...
for detection_layer in detection_layers:
    for object_detection in detection_layer:
        ...
        if confidence > 0.30:
            ...
            bounding_box = object_detection[0:4] * np.array([img_width, img_heigt, img_width, img_heigt])
